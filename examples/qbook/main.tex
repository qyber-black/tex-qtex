...
\verb|\bib{basename}| prints the bibliography, preceded by an optional
License chapter when \verb|\license{...}| is set.  The bibliography
...
\begin{figure}[htbp]
  ...
  are configured by the \texttt{caption} package in \texttt{qtex.sty}.}\label{fig:example}
\end{figure}
